...
<div data-role="page" id="page1">
    ...
    <a data-role="button" data-theme="e" id="btn-share" href="#share-modal" data-rel="dialog" data-transition="pop" ><?=lang('dashboard.infoshare')?></a>
    <a id="agent-call" data-role="button" data-theme="e" id="btn-localizame" href="#call-modal" data-rel="dialog" data-transition="pop" ><?=lang('dashboard.calltaxi')?></a>
  	<a id="btn-localizame" data-role="button"  data-theme="e"  ><?=lang('dashboard.localizame')?></a>
  	<a id="btn-exit" data-role="button"  data-theme="e"  >Salir</a>
        ...
        <a id="agent-call" data-role="button" data-theme="a" id="btn-localizame" href="#call-modal" class="ui-btn-right" data-rel="dialog" data-transition="pop" ><?=lang('dashboard.calltaxi')?></a>
       	<?= form_open('api/call', array('id' => 'call-form', 'class' => '')) ?>
            ...
            <div data-role="fieldcontain">
        		...
        		<tr><td >
                	<input name="address" id="address"  align="left" value="" type="text" data-mini="true" onkeydown="return validarEnter(event)">
            	</td><td >
...
<!-- Start of third page: #popup -->
<div data-role="page" id="share-modal" data-close-btn="none">
    
        <div data-role="header" data-theme="e">
            <h1><?=lang('dashboard.infoshare')?>:</h1>
            <span id="share-twitter2"></span>
            <span id="share-facebook2"></span>
        </div><!-- /header -->
        <div data-role="content" class="padding-0">
			<iframe id="targetFrame" src="" width="100%" height="200px"  frameborder="0" ></iframe>
    	</div>
